...
The `calculate_csv_coverage_stats.py` script provides aggregate statistics across multiple CSV files generated by the Swagger Coverage Analyzer. This tool is particularly useful when analyzing multiple API specifications or when you need to calculate overall coverage metrics.
...
```bash
python calculate_csv_coverage_stats.py /path/to/csv/files
```
...
python calculate_csv_coverage_stats.py "C:\Users\SFP7ZGX\Downloads\repos\SwaggerCoverage\results\csv"
```
